    ...
    public class PubContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var someBooks = new Book[]{
                ...
                new Book {BookId = 4,AuthorId=7,Title = "Alabaster", PublishDate = new DateTime(2019,4,1)},
                new Book {BookId = 5,AuthorId=7,Title = "The Never", PublishDate = new DateTime(2019, 12, 1) },
